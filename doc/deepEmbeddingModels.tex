...
\begin{table}[H]
    ...
    {data/em_models/rnn_simpsons_train.csv}%
    {model=\model, accuracy=\acc, precision=\prec, recall=\rec, F1=\fone}
    {\model & \acc & \prec & \rec & \fone}
...
\begin{table}[H]
    ...
    {data/em_models/rnn_simpsons_val.csv}%
    {model=\model, accuracy=\acc, precision=\prec, recall=\rec, F1=\fone}
    {\model & \acc & \prec & \rec & \fone}
...
\begin{table}[H]
    ...
    {data/em_models/rnn_simpsons_test.csv}%
    {model=\model, accuracy=\acc, precision=\prec, recall=\rec, F1=\fone}
    {\model & \acc & \prec & \rec & \fone}
...
\begin{table}[H]
    ...
    {data/em_models/rnn_friends_train.csv}%
    {model=\model, accuracy=\acc, precision=\prec, recall=\rec, F1=\fone}
    {\model & \acc & \prec & \rec & \fone}
...
\begin{table}[H]
    ...
    {data/em_models/rnn_friends_val.csv}%
    {model=\model, accuracy=\acc, precision=\prec, recall=\rec, F1=\fone}
    {\model & \acc & \prec & \rec & \fone}
...
\begin{table}[H]
    ...
    {data/em_models/rnn_friends_test.csv}%
    {model=\model, accuracy=\acc, precision=\prec, recall=\rec, F1=\fone}
    {\model & \acc & \prec & \rec & \fone}
...
\begin{table}[H]
    ...
    {data/em_models/bilstm_simpsons_train.csv}%
    {model=\model, accuracy=\acc, precision=\prec, recall=\rec, F1=\fone}
    {\model & \acc & \prec & \rec & \fone}
...
\begin{table}[H]
    ...
    {data/em_models/bilstm_simpsons_val.csv}%
    {model=\model, accuracy=\acc, precision=\prec, recall=\rec, F1=\fone}
    {\model & \acc & \prec & \rec & \fone}
...
\begin{table}[H]
    ...
    {data/em_models/bilstm_simpsons_test.csv}%
    {model=\model, accuracy=\acc, precision=\prec, recall=\rec, F1=\fone}
    {\model & \acc & \prec & \rec & \fone}
...
\begin{table}[H]
    ...
    {data/em_models/bilstm_friends_train.csv}%
    {model=\model, accuracy=\acc, precision=\prec, recall=\rec, F1=\fone}
    {\model & \acc & \prec & \rec & \fone}
...
\begin{table}[H]
    ...
    {data/em_models/bilstm_friends_val.csv}%
    {model=\model, accuracy=\acc, precision=\prec, recall=\rec, F1=\fone}
    {\model & \acc & \prec & \rec & \fone}
...
\begin{table}[H]
    ...
    {data/em_models/bilstm_friends_test.csv}%
    {model=\model, accuracy=\acc, precision=\prec, recall=\rec, F1=\fone}
    {\model & \acc & \prec & \rec & \fone}
